export default {
    ...
    dataForm:{
        ...
        "Choose_a_formula":"수식 선택",
        "Formula_type":"수식 유형",
        "Take_the_word_before_merger":"합병 전 말을 들자면",
        "example":"예를 들어",
        "total":"총",
        "number":"숫자",
        "ets":"등등",
    ...
    dataGrid:{
        ...
        "consolidation":"강화",
        "consolidationType":"연결 유형",
        "consolidationFormula":"연결 공식",
        ...
        "simple":"단순한",
        "size": "크기",
        "controllerNameSpace": "제어 장치 이름 공간",
        "Symbol":"상징",
        "type": "유형",
        "nickName": "닉네임",
    ...
    appAdmin: {
        ...
        "dark_mode": "다크 모드",
        "bright_mode": "밝은 모드",
        "description": "라우팅 정보를 올바르게 추가하려면 에이전트를 추가할 때 위에서 아래로 에이전트를 입력하십시오.",
        "data_processor": "데이터 프로세서",
        "original_preparation": "원래 준비",
        "dataProcessing": "데이터 처리",
